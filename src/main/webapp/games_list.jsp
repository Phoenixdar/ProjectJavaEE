...
<head>
    ...
    <style type="text/css">
        ...
        body {
            ...
            font-size: 12px;
            color: #999;
            background: #272525 url('img/ch.jpg');
        }
...
<%
    ...
    List<GameItem> gameItems = gameLibrary.getAllCollection();
        ...
        <div class="layer" >
            <div id="templatemo_menu" >
                <ul>
                    ...
                    <li><a href="games_list.jsp"  class="current">Games</a></li>
                ...
                <div class="templatemo_content margin_right_10">
                    <div id="scroll-layer1">
                        ...
                        <div class="content_section">
                            ...
                            <div class="margin_bottom_20"></div>
                            <button type="submit" class="btn-add" value="gameTitle">Add to library</button>
                        ...
                        <div class="margin_bottom_20 horizontal_divider"></div>
                        <div class="margin_bottom_20"></div>
                        <%if(parameter.equalsIgnoreCase("admin")){%>
                        <button type="submit" class="btn-add"  ><a href="add_dvd.jsp" style="color: #242224">Add New Game</a> </button>
                        <div class="margin_bottom_20 horizontal_divider"></div>
                        <div class="margin_bottom_20"></div>
                       <% }%>
